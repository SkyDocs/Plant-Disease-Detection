    ...
    return(
        <div className='teams' id='teams'>
            ...
            <ul class="list-group list-edit">
                ...
                <li class="list-group-item">Nirmit Shah 19MIM10049</li>
                <li class="list-group-item">Pushkar Verma 19BCG10087</li>
                <li class="list-group-item">Divyanshi Garg 19BCG10042</li>
                <li class="list-group-item">Harshwardhan Maske 19BME10001</li>
            </ul>
        </div>
    )
}
